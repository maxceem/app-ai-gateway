...
account shown with the terminal, and sign in or create your human account. The
page shows the account being claimed and the person approving, and one button
completes it. The CLI stays connected afterwards, so an interrupted command can
