...
URL and a separate code. Open the URL in a browser outside the agent's visible
session, enter the code, compare the account shown with the terminal, and sign
in or create your human account. Approve ownership and choose whether the CLI
...
with the person supplying the credential; provider handoffs do not need the
separate identity code. The page shows the provider, destination and proposed
