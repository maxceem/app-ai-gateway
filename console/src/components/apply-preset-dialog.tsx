...
export function ApplyPresetDialog({
  ...
  const ready =
    presetsComplete &&
    fragment.jwks_url.startsWith("https://") &&
    fragment.issuer.length > 0 &&
    fragment.audience.length > 0;
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <DialogBody className="space-y-4">
          <DialogDescription>
            Overwrites the JWKS URL, issuer and audience &mdash; the three fields that scope the
            app to one tenant &mdash; and adds any claim requirement the preset carries. Existing
