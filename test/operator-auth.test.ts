...
// (workerd has no node:crypto scrypt), which costs about two seconds each on
// an idle machine and more while the other test workers compete for the CPU.
// The default five seconds is not a bound on these tests, only a coin flip.
