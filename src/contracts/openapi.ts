...
export const ErrorResponseSchema = z.object({
  error: z.object({
    ...
    data: z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).optional().openapi({
      description: "Machine-readable facts about this rejection, present only where the code alone is not actionable. A billing_request_quota_exceeded rejection carries limit, used, and resetAt; an app_rate_limited or app_budget_exhausted rejection carries scope, either user or app.",
    }),
  }),
