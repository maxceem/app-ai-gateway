...
export const wranglerBin =
  process.env.APP_AI_GATEWAY_WRANGLER_BIN ?? join(projectRoot, "node_modules", ".bin", "wrangler");
    ...
    throw new Error(
      [
        ...
        available.length > 0
          ...
          : "No profiles exist yet; see the Deployment profiles section of the documentation.",
      ].join("\n"),
    );
  }
