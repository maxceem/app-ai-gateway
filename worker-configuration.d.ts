/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 1ed4f56751216323307971011602b13d)
...
interface __BaseEnv_Env {
	...
	USER_LIMITER: DurableObjectNamespace<import("./src/index").UserLimiter>;
	ORG_QUOTA: DurableObjectNamespace<import("./src/index").OrgQuota>;
	BILLING?: Service /* entrypoint BillingWorker from cf-billing */;
	SECRET_VAULT_LOCAL_KEK_CURRENT_VERSION?: "1";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserLimiter" | "OrgQuota";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "GATEWAY_TOKEN_TTL_SECONDS" | "CONFIG_CACHE_TTL_SECONDS" | "ALLOW_PUBLIC_REGISTRATION" | "OAUTH_PROXY_PRODUCTION_URL" | "SECRET_VAULT_MODE" | "JWT_SECRET" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "OAUTH_PROXY_SECRET" | "SECRET_VAULT_KMS_URL" | "SECRET_VAULT_KMS_TOKEN" | "SECRET_VAULT_LOCAL_KEK_CURRENT_VERSION">> {}
}
