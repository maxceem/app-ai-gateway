/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 5b24122a47345dd400a85446dbad7047)
...
interface __BaseEnv_Env {
	...
	ENDPOINT_RATE_LIMITER: DurableObjectNamespace<import("./src/index").EndpointRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserLimiter" | "OrgQuota" | "EndpointRateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SECRET_VAULT_MODE" | "SECRET_VAULT_LOCAL_KEK_CURRENT_VERSION" | "ALLOW_ADDITIONAL_REGISTRATIONS" | "DEPLOYMENT_ID" | "SECRET_VAULT_LOCAL_KEK_V1">> {}
}
